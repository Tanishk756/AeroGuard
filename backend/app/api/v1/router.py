...
from app.api.v1.routes.hardware_registry import router as hardware_registry_router
...
from app.api.v1.routes.simulation_orchestration import router as simulation_orchestration_router
...
router.include_router(simulation_orchestration_router, tags=["simulation_orchestrator"])
