...
EVENT_TYPES = frozenset({
    ...
    "INCIDENT_CLOSED", "INCIDENT_NOTE_ADDED", "INCIDENT_ACTION_LOGGED", "INCIDENT_EXPORT_CREATED",
    "INCIDENT_RETENTION_POLICY_CHANGED", "INCIDENT_ARCHIVE_ELIGIBILITY_EVALUATED", "INCIDENT_ARCHIVED",
    "INCIDENT_ARCHIVE_VERIFICATION_FAILED", "INCIDENT_PURGE_ELIGIBILITY_EVALUATED", "INCIDENT_PURGE_APPROVED",
    "INCIDENT_PURGED", "INCIDENT_RETENTION_HOLD_PLACED", "INCIDENT_RETENTION_HOLD_RELEASED",
    "INCIDENT_ARCHIVE_DOWNLOAD_URL_ISSUED", "INCIDENT_ARCHIVE_INTEGRITY_CHECKED",
    "INCIDENT_ARCHIVE_INTEGRITY_MISMATCH_DETECTED", "INCIDENT_ARCHIVE_ORPHAN_DETECTED",
})
